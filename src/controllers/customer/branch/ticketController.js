...
exports.view = (req, res) => {
  const { ticket_number, branch_id, additional_customer_id, sub_user_id, _token } = req.query;
...
exports.chat = (req, res) => {
  const { ticket_number, branch_id, additional_customer_id, sub_user_id, _token, message } = req.body;
...
exports.create = (req, res) => {
  const { branch_id, additional_customer_id, sub_user_id, _token, title, description } = req.body;
